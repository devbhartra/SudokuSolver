...
int nCol;
int nRow;
str_node Matrix[MAX_COL][MAX_ROW];
str_node Root;
str_node* RootNode = &Root;
str_node* RowHeader[MAX_ROW];
...
void Cover(str_node* ColNode) {
	str_node* RowNode,* RightNode;
...
void UnCover(str_node* ColNode) {
	str_node* RowNode,* LeftNode;
...
void SolutionRow(str_node* RowNode) {
